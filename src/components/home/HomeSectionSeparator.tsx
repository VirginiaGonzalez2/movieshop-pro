...
export default function HomeSectionSeparator({ genre }: { genre?: string | null }) {
    ...
    return (
        <div>
            ...
            <div className="mb-8">
                <h1 className="text-left text-2xl font-semibold mb-4">Top 5 most recent</h1>
                <TopRecentMoviesSection genre={genre} />
            </div>

            <div className="mb-8">
                <h1 className="text-left text-2xl font-semibold mb-4">Top 5 most purchased</h1>
                <TopPurchasedMoviesSection genre={genre} />
            </div>

            <div className="mb-8">
                <h1 className="text-left text-2xl font-semibold mb-4">Top 5 oldest</h1>
                <TopOldestMoviesSection genre={genre} />
            </div>

            <div className="mb-8">
                <h1 className="text-left text-2xl font-semibold mb-4">Top 5 cheapest</h1>
